"""
HMTI persona catalogue — converted from RoomieScout concepts/personas/data.ts.
Contains all 32 housemate types: 16 v1 (SD/SL/FD/FL suffix) + 16 v2 (DS/DF/HS/HF suffix).
"""
