...
PERSONAS: dict[str, PersonaMeta] = {
    # ── v1 codes (Structure before Conflict: SD/SL/FD/FL) ─────────────────────
    "NPSD": PersonaMeta(
        code="NPSD", title="The Peaceful Planner", emoji="🦉",
        ...
        character_direction="Calm authority: tidy, private, rule-minded. Focused planner energy — proud and peaceful, not bubbly.",
        palette=Palette("#e8f0fa", "#faf6ee", "#6b9fd4", "#d4e4f5", "#eef5fc", "#2d4a6e"),
        tagline="Quiet hours are my love language.",
        trait_badges=["Clean Nest", "Clear Rules", "Calm Routine"],
        roommate_superpower="Makes the home feel peaceful, predictable, and organized.",
        danger_zone="Messy kitchens, surprise guests, vague rules.",
        best_matches=["NPSL", "NPFD", "NOSD", "CPSD"],
        household_energy="Soft lamp. Clean counter. Calendar synced.",
    ),
    "NPSL": PersonaMeta(
        code="NPSL", title="The Quiet Minimalist", emoji="🐱",
        ...
        trait_badges=["Low Drama", "Clean Space", "Peaceful Vibes"],
        roommate_superpower="Stays respectful, tidy, and easy to live with.",
        danger_zone="Too much noise, too much talking, too many guests.",
        best_matches=["NPSD", "NPFL", "CPSL", "CPFL"],
        household_energy="Closed door. Fresh sheets. One plant. Silence.",
    ),
    "NPFD": PersonaMeta(
        code="NPFD", title="The Independent Organizer", emoji="🦊",
        ...
        trait_badges=["Clean Chaos", "Boundaries", "Independent"],
        roommate_superpower="Keeps things clean even with a flexible lifestyle.",
        danger_zone="People who ignore boundaries or enter shared space unpredictably.",
        best_matches=["NPSD", "NPFL", "NOFD", "CPFD"],
        household_energy="Desk lamp on. Planner open. Headphones ready.",
    ),
    "NPFL": PersonaMeta(
        code="NPFL", title="The Clean Ghost", emoji="✨",
        ...
        trait_badges=["Invisible", "Tidy", "Independent"],
        roommate_superpower="Creates almost no friction and keeps shared spaces clean.",
        danger_zone="Roommates who expect constant bonding or social energy.",
        best_matches=["NPSL", "NPFD", "CPSL", "CPFL"],
        household_energy="Empty couch. Folded towels. Footsteps you barely hear.",
    ),
    "NOSD": PersonaMeta(
        code="NOSD", title="The House Captain", emoji="🐕",
        ...
        trait_badges=["House Leader", "Clean Crew", "Friendly Rules"],
        roommate_superpower="Turns the apartment into a clean and connected household.",
        danger_zone="Roommates who hate structure or avoid communication.",
        best_matches=["NPSD", "NOSL", "NOFD", "COSD"],
        household_energy="Chore chart on fridge. Cookies in oven. Group chat buzzing.",
    ),
    "NOSL": PersonaMeta(
        code="NOSL", title="The Friendly Maintainer", emoji="🐶",
        ...
        trait_badges=["Friendly", "Tidy", "Easygoing"],
        roommate_superpower="Keeps the home friendly without making it feel over-managed.",
        danger_zone="Very messy roommates or people who never socialize.",
        best_matches=["NPSL", "NOSD", "NOFL", "COSL"],
        household_energy="Plants watered. Snacks out. Couch ready for one more.",
    ),
    "NOFD": PersonaMeta(
        code="NOFD", title="The Social Organizer", emoji="🐼",
        ...
        character_direction="Social architect: plans hangouts, sets boundaries, group-chat energy. Charismatic organizer — cool and in control.",
        palette=Palette("#ffe8e8", "#e8f5f5", "#e87868", "#ffd4d0", "#fff2f0", "#6e3a30"),
        tagline="Spontaneous plans, scheduled responsibly.",
        trait_badges=["Social", "Organized", "Guest-Ready"],
        roommate_superpower="Makes social living feel fun but still respectful.",
        danger_zone="Roommates who dislike guests or avoid shared planning.",
        best_matches=["NPFD", "NOSD", "NOFL", "COFD"],
        household_energy="Fairy lights on. Snack tray ready. Calendar has a fun block.",
    ),
    "NOFL": PersonaMeta(
        code="NOFL", title="The Clean Free Spirit", emoji="🦜",
        ...
        character_direction="Main-character roommate: fun, clean counters, spontaneous. Expressive parrot vibe — joyful but stylish.",
        palette=Palette("#e8f8ff", "#fff0f5", "#48b8d4", "#d4f0ff", "#f0faff", "#2d5a6e"),
        tagline="Good vibes, clean counters.",
        trait_badges=["Fun", "Fresh", "Flexible"],
        roommate_superpower="Brings energy without letting the home fall apart.",
        danger_zone="Strict rules, silent homes, and people who hate spontaneity.",
        best_matches=["NOSL", "NOFD", "COSL", "COFL"],
        household_energy="Music on. Counters wiped. Friends might drop by.",
    ),
    "CPSD": PersonaMeta(
        code="CPSD", title="The Boundary Keeper", emoji="🐢",
        ...
        character_direction="Boundary boss: calm, firm, protective of space. Grounded turtle — respectful tension, not aggressive.",
        palette=Palette("#e8f0e8", "#f5f0e8", "#5a8a5a", "#d4e8d4", "#f0f5f0", "#2e4a2e"),
        tagline="Respect the space, and we're good.",
        trait_badges=["Private", "Steady", "Boundaries"],
        roommate_superpower="Sets clear boundaries without needing a perfect home.",
        danger_zone="Unannounced guests, shared belongings being used, forced socializing.",
        best_matches=["NPSD", "CPSL", "CPFD", "COSD"],
        household_energy="Knock first. Labels on shelves. Your stuff stays yours.",
    ),
    "CPSL": PersonaMeta(
        code="CPSL", title="The Easygoing Independent", emoji="🐼",
        ...
        character_direction="Chill independent: low drama, private, steady. Unbothered panda — neutral cool, not lazy-cute.",
        palette=Palette("#f0f0f0", "#f5f5eb", "#6e6e6e", "#e0e0e0", "#f8f8f8", "#3a3a3a"),
        tagline="No drama, no pressure, no problem.",
        trait_badges=["Chill", "Private", "Steady"],
        roommate_superpower="Keeps things peaceful and low-pressure.",
        danger_zone="Roommates who micromanage or expect constant interaction.",
        best_matches=["NPSL", "NPFL", "CPSD", "COSL"],
        household_energy="Beanbag dent. Headphones on. Snacks within reach.",
    ),
    "CPFD": PersonaMeta(
        code="CPFD", title="The Flexible Boundary Setter", emoji="🦔",
        ...
        character_direction="Night-owl with rules: flexible schedule, clear lines. Cozy but guarded hedgehog — focused, not scared.",
        palette=Palette("#ede8f8", "#f5f0e8", "#8a6ab8", "#ddd0f0", "#f5f0fa", "#4a3a5c"),
        tagline="I'm up late, but I respect the rules.",
        trait_badges=["Night Owl", "Private", "Clear Lines"],
        roommate_superpower="Balances irregular routines with clear boundaries.",
        danger_zone="Strict schedules, surprise social demands, unclear expectations.",
        best_matches=["NPFD", "CPSD", "CPFL", "COFD"],
        household_energy="Laptop glow. Hoodie on. Quiet after midnight.",
    ),
    "CPFL": PersonaMeta(
        code="CPFL", title="The True Ghost Roommate", emoji="🦇",
        ...
        character_direction="True ghost: rare sightings, pays rent, zero friction. Sleepy bat energy — amused, not helpless.",
        palette=Palette("#e8e8f5", "#f0f0f8", "#6a6a9e", "#d8d8ec", "#f0f0f8", "#3a3a52"),
        tagline="Seen once a week. Pays rent on time.",
        trait_badges=["Invisible", "Chill", "Independent"],
        roommate_superpower="Barely interferes with anyone's life.",
        danger_zone="House meetings, chore charts, forced bonding, high-cleanliness homes.",
        best_matches=["NPSL", "NPFL", "CPSL", "CPFL"],
        household_energy="Lights low. Door half-shut. You forget they're home.",
    ),
    "COSD": PersonaMeta(
        code="COSD", title="The Communal Manager", emoji="🫶",
        ...
        character_direction="Communal anchor: fair, warm, responsible shared living. Calm capybara host — grounded leader.",
        palette=Palette("#fff5e8", "#f0f5e8", "#c49050", "#ffe8c8", "#fffaf2", "#5c4a28"),
        tagline="Shared snacks, shared rules, shared vibes.",
        trait_badges=["Communal", "Fair", "Grounded"],
        roommate_superpower="Creates a warm home where people still know the expectations.",
        danger_zone="Roommates who avoid communication or never contribute.",
        best_matches=["NOSD", "CPSD", "COSL", "COFD"],
        household_energy="Shared dinner. Whiteboard updated. Everyone chipped in.",
    ),
    "COSL": PersonaMeta(
        code="COSL", title="The Warm Housemate", emoji="🐻",
        ...
        character_direction="Emotional comfort: cozy, social, steady. Gentle bear warmth — welcoming, not childish soft.",
        palette=Palette("#fff5e8", "#ffeef0", "#d4a050", "#ffe8c8", "#fffaf5", "#5c4020"),
        tagline="Mi casa is kinda your casa.",
        trait_badges=["Warm", "Social", "Chill"],
        roommate_superpower="Makes the apartment feel emotionally comfortable.",
        danger_zone="Cold, silent, overly strict households.",
        best_matches=["NOSL", "NOFL", "CPSL", "COFL"],
        household_energy="Tea brewing. Blanket pile. Someone's always welcome.",
    ),
    "COFD": PersonaMeta(
        code="COFD", title="The Social Negotiator", emoji="🦝",
        ...
        character_direction="Social negotiator: brings energy + etiquette. Clever raccoon — playful smirk, persuasive, not chaotic mess.",
        palette=Palette("#e8f0ff", "#fff0e8", "#5090d4", "#d4e8ff", "#f0f8ff", "#2d4a6e"),
        tagline="I bring the energy and the group chat etiquette.",
        trait_badges=["Social", "Flexible", "Negotiator"],
        roommate_superpower="Keeps flexible social living from becoming total chaos.",
        danger_zone="Strict privacy needs, rigid quiet hours, cleanliness perfectionism.",
        best_matches=["NOFD", "CPFD", "COSD", "COFL"],
        household_energy="String lights up. Guest rules posted. Snacks for everyone.",
    ),
    "COFL": PersonaMeta(
        code="COFL", title="The Party-Compatible Roommate", emoji="🦦",
        ...
        character_direction="Party-compatible: living room is the vibe. Otter hype — spontaneous fun, cool roommate not toddler energy.",
        palette=Palette("#e8f8ff", "#fff0f8", "#5ab8d4", "#d4f0ff", "#f0faff", "#2d5a6e"),
        tagline="The living room is a lifestyle.",
        trait_badges=["Social", "Spontaneous", "Unfiltered Fun"],
        roommate_superpower="Makes the apartment feel alive and fun.",
        danger_zone="Strict rules, early sleepers, clean freaks, quiet-only homes.",
        best_matches=["NOSL", "NOFL", "COSL", "COFD"],
        household_energy="Speaker on. Pizza boxes. Plans happen tonight.",
    ),

    # ── v2 codes (Conflict before Structure: DS/DF/HS/HF) ─────────────────────
    "NPDS": PersonaMeta(
